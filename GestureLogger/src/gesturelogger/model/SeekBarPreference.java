...
public class SeekBarPreference extends Preference implements OnSeekBarChangeListener{
	...
	protected View onCreateView(ViewGroup parent){
		...
		LinearLayout.LayoutParams params2 = new LinearLayout.LayoutParams( 510, LinearLayout.LayoutParams.WRAP_CONTENT );
		params2.gravity = Gravity.RIGHT;
		
		
		LinearLayout.LayoutParams params3 = new LinearLayout.LayoutParams( 60, LinearLayout.LayoutParams.WRAP_CONTENT );
	...
	protected Object onGetDefaultValue(TypedArray ta,int index){
		...
		int dValue = (int)ta.getInt(index,255);
